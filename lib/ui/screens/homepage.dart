...
//                     ),
//                   ),
//                   Container(child: Icon(Icons.notification_add_outlined)),
//                 ],
//               ),
//               SizedBox(height: 20),
//               Container(
//                 child: Text(
//                   "Votre outil terrain au service de la sécurité",
//                   style: TextStyle(
...
//                       //   context,
//                       //   MaterialPageRoute(
//                       //     builder: (context) => const PlateRecognitionScreen(),
//                       //   ),
//                       // );
//                     },
//                   ),
...
import 'package:niit/ui/widgets/app_bar.dart';
import 'package:niit/utils/colors.dart';
// import 'package:niit/ui/screens/scan/plate_recognition.dart';
...
class _HomePageState extends State<HomePage> {
  ...
  //             mainAxisSize: MainAxisSize.min,
  //             children: [
  //               Icon(icon, size: 40, color: AppColors.k_accent_yellow),
  //               const SizedBox(height: 16),
  //               Text(
  //                 label,
  ...
  Widget _buildCard(
    ...
    return Card(
      ...
      elevation: 8, // Augmenter l'élévation pour une ombre plus visible
      shadowColor: AppColors.k_card_green.withOpacity(0.6), // Ombre verte
      shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(12)),
      child: InkWell(
        onTap: onTap,
        borderRadius: BorderRadius.circular(12),
